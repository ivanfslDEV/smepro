...
export function ScheduleContent({ business }: ScheduleContentProps) {
    ...
    async (date: Date): Promise<string[]> => {
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_URL}/api/schedule/get-appointments?userId=${business.id}&date=${dateString}`
        );
  ...
  async function handleRegisterAppointment(formData: AppointmentFormData) {
    ...
    toast.success(<div data-cy="toast-success">Appointment Scheduled!</div>);
    form.reset();
    setSelectedTime("");
  }
        ...
        <div className="max-w-2xl mx-auto">
          <article className="flex flex-col items-center">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>
                {business.address ? business.address : "Address not informed"}
              </span>
            </div>
          </article>
        </div>
                ...
                <FormItem className="my-2 mt-3 max-w-full">
                  ...
                  <FormControl>
                    <Select onValueChange={field.onChange}>
                      <SelectTrigger
                        className="w-full"
                        data-cy="service-select-appointment-form"
                      >
                        <SelectValue placeholder="Select a Service" />
                      </SelectTrigger>
                      <SelectContent data-cy="service-select-appointment-form-content">
